...
dataset = ShapeNet( train=True, class_choice=opt.category, npoints_line=opt.super_points, npoints_square=opt.super_points)
dataloader = torch.utils.data.DataLoader(dataset, batch_size=opt.batchSize,
                                         shuffle=True, num_workers=int(opt.workers))

dataset_test = ShapeNet( train=False, class_choice=opt.category, npoints_line=opt.super_points, npoints_square=opt.super_points)
...
# Create network
network = AE_CurSkeNet(num_points=opt.num_points, nb_primitives=opt.nb_primitives)
