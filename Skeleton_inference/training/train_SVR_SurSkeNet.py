...
if opt.fix_decoder == 'True':
    network_preTrained_autoencoder = AE_SurSkeNet(num_points=opt.num_points, nb_primitives=opt.nb_primitives)
...
# Create network
network = SVR_SurSkeNet(num_points=opt.num_points, nb_primitives=opt.nb_primitives)
