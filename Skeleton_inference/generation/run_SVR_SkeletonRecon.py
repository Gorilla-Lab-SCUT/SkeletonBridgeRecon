...
dataset = ShapeNet(SVR=True, class_choice=opt.category, normal=False, train=False)  # train or test?
...
for i, data in enumerate(dataloader, 0):
    ...
    outdir = './output/%s_SVR_Curve%d_Sheet%d'%(opt.category, opt.gen_line_points, opt.gen_square_points)
    ...
    write_ply(filename=outdir + "/" + fn + "_" + idx + "_GT",
